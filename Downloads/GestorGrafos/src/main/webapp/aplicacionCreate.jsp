...
<div class="form-container">
    ...
    <form action="aplicacionCreateServlet" method="post">
        ...
        <label for="enlaceYouTube">Enlace de YouTube:</label>
        <input type="text" id="enlaceYouTube" name="enlaceYouTube" required>
