...
<head>
    ...
    <title>Eliminar Desarrollador</title>
    <style>
        body {
...
<div class="form-container">
    <h1>Eliminar Desarrollador</h1>
    <form action="desarrolladorDeleteServlet" method="post">
        <label for="nombre">Nombre del Desarrollador:</label>
        <input type="text" id="nombre" name="nombre" required>

        <div class="button-container">
            <input type="submit" value="Eliminar Desarrollador">
